...
{
  header("location:cpanel-anggota-tampil.php");
}
?>
<head>
...
<div class="cpanel-menu">
	<li class="cpanel-menu-text"><a href=cpanel-admin.php>Anggota</a></li>
	<li class="cpanel-menu-text active">PROFIL
    	<div class="menu-kiri-content">
       		<a class="active" href=cpanel-anggota-ubah.php?&id=<?php echo $id ?>>Ubah Data Anggota</a>

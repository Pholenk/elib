    ...
    <li class="cpanel-menu-text active">Peraturan
    	<div class="menu-kiri-content">
    		<a href=cpanel-admin-aturan-tambah.php>Tambah Aturan</a>
       		<a class="active" href=cpanel-admin-aturan-tampil.php>Tampil Aturan</a>
...
<table >
  ...
  <tr class="tampil">
   ...
   if($aturan!=0)
   {
    ...
    {
      ?>
      <td class="tampil"><?php echo $data["id_aturan"] ?></td>
      <td class="tampil"><?php echo $data["aturan"] ?></td>
      <td class="tampil"><a class = "tabel" href="cpanel-admin-aturan-ubah.php?&id=<?php echo $data["id_aturan"]; ?>"</a>Ubah </td>
      <?php
    }
  }
  else
  {?>
    <td class="tampil" colspan= "3">DATA TIDAK ADA</td><?php ;
  }

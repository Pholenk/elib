    ...
    <li class="cpanel-menu-text active">Buku
    	<div class="menu-kiri-content">
    		<a href=cpanel-admin-buku-tambah.php>Tambah Data Buku</a>
       		...
       		<a class="active" href=cpanel-admin-buku-tampil.php>Tampil Data Buku</a>
		</div>
	</li>
...
<div class="content">
<h2 style="text-align: center; margin:0; padding:15px 0; font-family: 'Arial Black', Gadget, sans-serif;">Tampil Buku</h2>
<br></br>
<table>
      <th>ISBN</th>
      <th>Judul</th>
      ...
      <?php
        foreach ($buku as $data) 
        {
          ?>
          <tr class="tampil">
          <td class="tampil"><?php echo $data["isbn"] ?></td>
          <td class="tampil"><?php echo $data["judul"] ?></td>
          <td class="tampil"><?php echo $data["jumlah"] ?></td>
          <td class="tampil"><a class = "tabel" href="cpanel-admin-buku-ubah.php?&id=<?php echo $data["isbn"]; ?>"</a>Ubah </td>
          <?php
        }
      ?>
          </tr>

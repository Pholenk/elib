...
<div class="cpanel-menu">
    ...
    <li class="cpanel-menu-text active">Buku
    	<div class="menu-kiri-content">
    		<a class="active" href=cpanel-admin-buku-tambah.php>Tambah Data Buku</a>
            ...
            <table>
                <tr>
                  ...
                  <tr>
                    ...
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="judul" class="input-textfield"/></span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Penulis</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="penulis" class="input-textfield"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Tahun Terbit</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="th_terbit" class="input-textfield"/><br />
                    </span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Tempat Terbit</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="tmpt_terbit" class="input-textfield"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Penerbit</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="penerbit" class="input-textfield"/></span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Edisi</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="edisi" class="input-textfield"/></span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Kategori</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="kategori" class="input-textfield"/></span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Jumlah</span></td>
                    <td class="regis">
                    <span class="formulir-text"><input type="text" name="jumlah" class="input-textfield"/></span></td>
                  </tr>
                  <tr>
                    <td><span class="formulir-text">Deskripsi Fisik</span></td>
                    <td class="regis">
                    <span class="formulir-text"><textarea name="deskripsi" cols="45" rows="5"></textarea></span>
                    </td>
                  </tr>
                </table><br><br>
        ...
        <?php
          if($_POST)
          {
            ...
            else
            {
              ...
              if($in->cek_buku($_POST['isbn'])==FALSE)
              {
                if($in->tambahbuku()==TRUE)
                {
                  ?>
                  <script language="javascript">

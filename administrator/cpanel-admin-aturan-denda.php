...
<div class="cpanel-menu">
    ...
    <li class="cpanel-menu-text active">Peraturan
    	<div class="menu-kiri-content">
            ...
            <a class="active" href=cpanel-admin-aturan-denda.php>Ubah Denda</a>
		</div>
	</li>
</div>
<div class="content">
<h2 style="text-align: center; margin:0; padding:15px 0; font-family: 'Arial Black', Gadget, sans-serif;">DENDA</h2>
	<div class="formulir">
	<form class="registrasi" name="registrasi" method="post" action="">
		<table>
        	<tr>
            	<td width="24%"><span class="formulir-text">DENDA</span></td>
            	<td class="regis"><span class="formulir-text">
                <input type="text" name="denda" class="input-textfield" /></span></td>
	        </tr>
		</table><br><br>
    ...
    <?php
      if($_POST)
      {
        $in->nom_denda = $_POST["denda"];
        $in->ubahdenda();
        if($in->ubahdenda()==TRUE)
        {
          ?>
            <script language="javascript">
            alert("data berhasil disimpan");
            document.location="cpanel-admin-aturan-denda.php";
            </script>
          <?php
        }
        else
